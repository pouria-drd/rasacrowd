...
const Banner = () => {
    return (
        <div className="text-white font-vazir
        ...
        rounded-xl w-full pt-20 pb-10 px-12 md:py-16">
            ...
            text-center md:text-right cursor-default">
                ...
                <p className="text-center md:text-right text-wrap
                r2l md:max-w-60 lg:max-w-96">
                    بستری است برای ارتباط
                    میان صاحبان ایده، تیم های استارتاپی و کسب و کارهای در حال توسعه
                    با سرمایه گذاران...
                </p>
            </div>
